---
layout: default
title: LaneLayer Guide Reference
---

# LaneLayer Build Guide - Complete Reference

> This page contains the complete technical reference for building lanes on LaneLayer. It's structured for AI assistants to parse and reference when helping users build custom lanes.

## When to Use LaneLayer

Build on LaneLayer if your app needs any two of these:

- **Value flows you can't fake** — no rollbacks, no quiet bailouts
- **Rules that can't change** — no hot-patches, pauses, or "emergency upgrades"
- **A backend that survives** — keeps running even if the original team disappears
- **Multi-party settlement** — no operator trusted to be honest
- **Bitcoin-denominated capital** — not platform tokens

If none apply, you're building a normal app.
...
- [LaneLayer Discord](https://discord.gg/Br7aunCs) - Get help and share your projects
